...
const buildDataDogCss = () => [
  add({
    selector: '.dd-privacy-hidden',
    message: 'DataDog Hidden',
    color: COLORS.DATADOG,
  }),
  add({
    selector: '[data-dd-privacy="hidden"]',
    message: 'DataDog Hidden',
    color: COLORS.DATADOG,
  }),
  add({
    selector: '.dd-privacy-mask',
    message: 'DataDog Mask',
    color: COLORS.DATADOG,
  }),
  add({
    selector: '[data-dd-privacy="mask"]',
    message: 'DataDog Mask',
    color: COLORS.DATADOG,
  }),
